...
// Module represents the discount module
type Module struct {
...
// GetHandler returns the discount handler
func (m *Module) GetHandler() *Handler {
	return m.handler
}

// GetService returns the discount service
func (m *Module) GetService() Service {
	return m.service
}

// GetRepository returns the discount repository
