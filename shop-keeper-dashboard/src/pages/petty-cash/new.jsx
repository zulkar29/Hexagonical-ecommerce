  ...
  return (
    <div className="space-y-6 p-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold tracking-tight">New Petty Cash Transaction</h1>
        ...
        <div className="lg:col-span-3">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Fill in the details for the petty cash transaction
              </CardDescription>
            </CardHeader>
            <CardContent>
                  ...
                  <div className="border-2 border-dashed border-muted-foreground/25 rounded-lg p-6 text-center">
                    ...
                    <div className="space-y-2">
                      <p className="text-sm text-muted-foreground">
                        {receiptFile ? receiptFile.name : "Upload receipt or supporting document"}
                      </p>
                      <input
                        type="file"
                        id="receipt"
...
export default NewPettyCashTransaction;