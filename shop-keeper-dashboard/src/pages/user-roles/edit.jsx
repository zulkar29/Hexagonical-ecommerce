...
import { ArrowLeft, ShieldCheck, Users, Settings, FileText, CreditCard, Package, AlertTriangle } from "lucide-react";
...
const mockRoles = {
  1: { 
    ...
    users: 2,
    permissions: ["products_view", "products_create", "products_edit", "products_delete", "orders_view", "orders_manage", "orders_cancel", "customers_view", "customers_edit", "customers_delete", "payments_view", "payments_refund", "settings_view", "settings_edit", "users_manage"]
  },
  2: { 
    id: 2, 
    name: "Manager", 
    ...
    users: 4,
    permissions: ["products_view", "products_create", "products_edit", "orders_view", "orders_manage", "customers_view", "customers_edit", "payments_view"]
  },
  3: { 
    id: 3, 
    name: "Support", 
    ...
    users: 3,
    permissions: ["orders_view", "customers_view", "customers_edit"]
  },
  4: { 
    id: 4, 
    name: "Viewer", 
    ...
    users: 1,
    permissions: ["products_view", "orders_view", "customers_view", "payments_view"]
  },
};
...
const EditRole = () => {
  ...
  const onSubmit = (data) => {
    ...
    console.log("Role updated:", formData);
    navigate("/user-roles");
  };
    ...
    <div className="space-y-4 sm:space-y-6 p-3 sm:p-4 lg:p-6">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl sm:text-2xl font-bold tracking-tight">Edit Role</h1>
            <p className="text-sm text-muted-foreground">Modify permissions and details for {roleData.name}</p>
          </div>
        </div>
      </div>
          ...
          <CardContent className="pt-6">
            <div className="flex items-start gap-3">
              ...
              <div className="space-y-1">
                <p className="font-medium text-amber-800">Active Users Warning</p>
                <p className="text-sm text-amber-700">
                  This role is currently assigned to <strong>{roleData.users} user{roleData.users > 1 ? 's' : ''}</strong>. 
                  Changes to permissions will take effect immediately for all assigned users.
                </p>
              </div>
            </div>
          </CardContent>
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1">
                        <h3 className="font-medium">{roleData.name}</h3>
                        <p className="text-xs text-muted-foreground">ID: {roleData.id}</p>
                      </div>
                    </div>
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center justify-between text-sm">
                        ...
                        <Badge variant={roleData.users > 0 ? "default" : "secondary"}>
                          {roleData.users}
                        </Badge>
                      </div>
                      <div className="flex items-center justify-between text-sm">
