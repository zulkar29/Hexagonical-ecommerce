...
export default function CreateCategory() {
  ...
  useEffect(() => {
    if (parentId) {
      const parent = flatCategories.find(cat => cat.id === parseInt(parentId));
      if (parent) {
                  ...
                  <div className="space-y-2">
                    ...
                    <Select value={form.parent_id || "none"} onValueChange={handleParentChange}>
                      ...
                      <SelectContent>
                        ...
                        {flatCategories.map(renderCategoryOption)}
                      </SelectContent>
                    </Select>
                    {selectedParent && (
                      <div className="flex items-center gap-2 text-sm text-muted-foreground">
                        <span>Will be created under:</span>
                      ...
                      <div className="relative">
                        <div className="w-full h-48 bg-gray-100 rounded-lg flex items-center justify-center border">
                          <div className="text-center">
                            ...
                            <p className="text-sm text-gray-600">{form.image.name}</p>
              ...
              <div className="p-4 border rounded-lg">
                ...
                {selectedParent && (
                  <div className="flex items-center gap-1 text-xs text-muted-foreground mb-2">
                    ...
                    <span>{form.name || "New Category"}</span>
                  </div>
                )}
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              <div className="text-sm text-muted-foreground space-y-2">
                <p><strong>Category Hierarchy:</strong> Use parent categories to organize products logically</p>
                <p><strong>SEO:</strong> Include relevant keywords in title and description</p>
                <p><strong>Images:</strong> High-quality images improve user experience</p>
                <p><strong>Slug:</strong> Keep URLs short and descriptive</p>
              </div>
            </CardContent>
          </Card>
        </div>
